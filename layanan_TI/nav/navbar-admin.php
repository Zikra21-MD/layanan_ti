    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto"> <!-- ms-auto untuk menempatkan menu di kanan -->
                <li class="nav-item">
                    <a class="nav-link" href="../admin/main.php">Dashboard</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../admin/user_manage.php">kelola pengguna</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../admin/masalah.php">kelola masalah</a>
                </li>
                <!-- Profile dropdown -->
